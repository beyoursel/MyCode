...
class Box3D:
    ...
    def bbox2array_raw(cls, bbox):
        if bbox.s is None:
            ...
            return np.array([bbox.x, bbox.y, bbox.z, bbox.l, bbox.w, bbox.h, bbox.ry, bbox.s])
    ...
    def array2bbox_raw(cls, data):
        ...
        Returns:
        """
        # take the format of data of [x, y, z, h, w, l, theta]
        bbox = Box3D()
        bbox.x, bbox.y, bbox.z, bbox.l, bbox.w, bbox.h, bbox.ry =  data[:7]
        if len(data) == 8:
            bbox.s = data[-1]
        return bbox
    ...
    def box2corners3d_camcoord(cls, bbox):
        ...
        Returns:
            corners_3d: (8, 3) array in the rect camera coord
        ...
        # rotate and translate 3d bouding box
    ...
    def box2corners2d(cls, bbox):
        ...
        cos, sin = np.cos(bbox.ry), np.sin(bbox.ry)
    ...
    def box2corners3d_lidar(cls, bbox):
        ...
        corners_3d = np.concatenate([up_corners, bottom_corners], axis=0)
