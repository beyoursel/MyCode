...
from pcdet.datasets.once_xx_rs.once_toolkits import Octopus
...
class ONCEDataset(DatasetTemplate):
    ...
    def get_infos(self, num_workers=4, sample_seq_list=None):
        ...
        def process_single_sequence(seq_idx):
            ...
            # info_this_seq = eval(info_this_seq) 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default="/media/taole/ssd1/letaotao/OpenPCDet/tools/cfgs/dataset_configs/once_dataset.yaml", help='specify the config of dataset')
