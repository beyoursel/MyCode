...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default="/media/taole/ssd1/letaotao/OpenPCDet_New/tools/cfgs/dataset_configs/waymo_dataset.yaml", help='specify the config of dataset')
