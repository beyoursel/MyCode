...
class SpatialGroupConvV2(spconv.SparseModule):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=1, bias=False, indice_key=None, position_embedding=True, use_relu=True):
...
class VoxelResBackBone8xLargeKernel3D(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        kernel_sizes = model_cfg.get('KERNEL_SIZES', [5, 5, 5, 3])
