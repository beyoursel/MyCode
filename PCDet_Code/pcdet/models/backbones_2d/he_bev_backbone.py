...
from .hest_att import Attention
...
class Hed2DBackbone(nn.Module):
    def __init__(self, model_cfg, input_channels):
        ...
        self.he01 = Attention(128)
        self.he02 = Attention(128)

        self.he11 = Attention(256)
        self.he12 = Attention(256)
