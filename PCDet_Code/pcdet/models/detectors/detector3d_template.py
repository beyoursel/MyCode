...
class Detector3DTemplate(nn.Module):
    ...
    def build_backbone_2d(self, model_info_dict):
        ...
        backbone_2d_module = backbones_2d.__all__[self.model_cfg.BACKBONE_2D.NAME](
            ...
            input_channels=model_info_dict.get('num_bev_features', None) if model_info_dict.get('num_bev_features', None) is not None else model_info_dict.get('num_point_features', None)
        )
