...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='/media/taole/ssd1/letaotao/OpenPCDet_New/tools/cfgs/once_models/centerpoint.yaml', help='specify the config for training')
